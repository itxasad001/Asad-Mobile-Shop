            ...
            :""}
             ...
             <TableCell  align='center'>
              <Button onClick={()=>{
                ...
                axios.delete("https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-subdelete",{
                  params:{
                    _id:elements._id
                  }
                })
...
const [datafor, setdatafor]=useState([])
    ...
    axios.get('https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-get').then(res=> {
      setdata(res.data)
...
const [state, setstate] =useState()
  ...
  /*
https://australia-research-ai-jobs-tasks-at.vercel.app

https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-datesget
...
*/
 ...
 axios.post('https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-post',payload).then(res => {
  console.log(res.data)
...
axios.get('https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-get').then(res=> {
    ...
    axios.get('https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-datesget')
      .then(res=> {
...
.catch(err => err)
  ...
  const res = await axios.get('https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-get')
  setdata(res.data)
}
...
useEffect(()=>{
  ...
  const onspecificdays = (e)=>{
    ...
    axios.get('https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-sevenget',{
      params:{
        days:selectValue
      }
  ...
  const onspecificdate = (e)=>{
    ...
    axios.get('https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-date',{
 ...
 const onyearchange =  (e)=>{
      ...
      axios.get("https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-year",{
        params:{
          year:value
        }
...
axios.get("https://australia-research-ai-jobs-tasks-at.vercel.app/api/form/form-month",{
